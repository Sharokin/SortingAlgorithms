...
void quickSortFunc1(ElementType* arrayToSort, int high, int low, Statistics* statistics);

int partition(ElementType* arrayToSort, int high, int low, Statistics* statistics);
#endif
